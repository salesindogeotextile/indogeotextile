            ...
            {!generatedContent && !isGenerating ? (
              ...
              >
                ...
                <div className="mt-10 text-center">
                  <h3 className="text-xl font-bold text-slate-900 mb-2 font-sans">AI sedang bekerja...</h3>
              ...
              <motion.div 
                ...
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="h-full min-h-[60vh] flex flex-col items-center justify-center text-center px-6"
              >
                ...
                <button 
                  onClick={() => handleGenerate()}
                  className="mt-8 px-6 py-2 bg-slate-900 text-white rounded-xl text-sm font-bold hover:bg-slate-800 transition-all"
                >
                  Coba Lagi
                </button>
              </motion.div>
